    ...
    private void onClickEvents() {
        tvAbout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Malaria.this,AboutActivity.class));
                Malaria.this.overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
        ...
        tvPrevention.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Malaria.this,PreventionActivity.class));
                Malaria.this.overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
            }
        });
        ...
        tvSymptoms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Malaria.this,SymptomsActivity.class));
                Malaria.this.overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
            }
        });
